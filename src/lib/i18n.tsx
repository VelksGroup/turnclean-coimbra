...
const translations: Record<LanguageCode, Translation> = {
  es: {
    ...
    s4: {
      ...
      a1: "Limpieza profunda",
      a2: "Limpieza post-obra",
      a3: "Servicio fuera de horario",
  ...
  en: {
    ...
    s4: {
      ...
      a1: "Deep cleaning",
      a2: "Post-renovation cleaning",
      a3: "Out of hours service",
  ...
  fr: {
    ...
    s4: {
      ...
      a1: "Nettoyage en profondeur",
      a2: "Nettoyage fin de chantier",
      a3: "Service hors horaires",
  ...
  de: {
    ...
    s4: {
      ...
      a1: "Tiefenreinigung",
      a2: "Bauendreinigung",
      a3: "Service außerhalb der Zeiten",
  ...
  uk: {
    ...
    s4: {
      ...
      a1: "Глибоке прибирання",
      a2: "Прибирання після ремонту",
      a3: "Обслуговування в неробочий час",
  ...
  ru: {
    ...
    s4: {
      ...
      a1: "Глубокая уборка",
      a2: "Уборка после ремонта",
      a3: "Услуги вне графика",
  ...
  pl: {
    ...
    s4: {
      ...
      a1: "Sprzątanie gruntowne",
      a2: "Sprzątanie po remoncie",
      a3: "Usługi poza godzinami",
  ...
  nl: {
    ...
    s4: {
      ...
      a1: "Diepe reiniging",
      a2: "Schoonmaak na renovatie",
      a3: "Service buiten kantooruren",
      a4: "Noodgevallen",
  ...
  no: {
    ...
    s4: {
      ...
      a1: "Dyprengjøring",
      a2: "Byggrengjøring",
      a3: "Tjenester utenfor arbeidstid",
      a4: "Akutte tilfeller",
